...
/**
 * Remove extra whitespace characters from a string,
 * preserving a single space character
 *
...
describe('gulp-little-template', function () {
  ...
  var expectedFileWithEmbed = new gutil.File({
    ...
    contents: fs.readFileSync(
      'test/expected/outputWithEmbeddedTemplate.html'
    )
  });

  it('should produce correct html output when rendering a file',
     function (done) {
  ...
  it('should produce correct html output with a specific file extension',
     function (done) {
  ...
  it('should produce correct html output using embedded templates',
     function (done) {
       ...
       stream.on('data', function (newFile) {
         ...
         removeExtraWhitespaceChars(String(newFile.contents))
           .should.equal(removeExtraWhitespaceChars(
              String(expectedFileWithEmbed.contents)
         ));
         done();
       });
